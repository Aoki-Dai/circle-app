                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid items-center grid-cols-2 gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <h1 class="text-4xl font-bold text-black dark:text-white">サークルなう</h1>
                        </div>
                        @if (Route::has('login'))
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-3 lg:gap-8">
                            <div class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                <h2 class="text-xl font-semibold text-black dark:text-white">リアルタイム入室管理</h2>
                                <p class="mt-4 text-sm/relaxed">
                                    サークルなうは、部室の状況をリアルタイムで把握できる入室管理アプリです。誰が部室にいるのか、いつ入室したのかを簡単に確認できます。
                                </p>
                            </div>

                            <div class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                <h2 class="text-xl font-semibold text-black dark:text-white">簡単な操作</h2>
                                <p class="mt-4 text-sm/relaxed">
                                    サークルなうは、ボタンを押すだけの簡単入室処理で直感的な操作が可能です。{{-- QRコードをスキャンするだけで入室・退室の管理ができます。 --}}
                                </p>
                            </div>

                            <div class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                <h2 class="text-xl font-semibold text-black dark:text-white">安全なデータ管理</h2>
                                <p class="mt-4 text-sm/relaxed">
                                    サークルなうは、ユーザーのデータを安全に管理します。プライバシーを守りながら、部室の利用状況を正確に記録します。
                                </p>
                            </div>
                        </div>
                    </main>
